class SyntaxAnalyzer {
    ...
    checkStack(params) {
        if (!this.hasErrors) {
            if (
                this.stack.length == params.depth &&
                ...
                giveError(
                    params.errorMsg +
                        ' Line: ' +
                        this.arrLexems[this.index].linenmb
                );
                this.hasErrors = true;
            }
        }
    ...
    checkVarStatement() {
        ...
        this.checkStack({
            depth: 0,
            codeLexem: 3,
            errorMsg: 'You forgot let  word in your code !'
        });
        if (this.hasErrors) return;
    ...
    inspectMnoj() {
        ...
        if (this.arrLexems[this.index].codeLexem == 34) {
            ...
            this.hasErrors = true;
            giveError(
                'Unexpexted Token! Line: ' +
                    (this.arrLexems[this.index].linenmb + 1)
            );
        }
    ...
    inspectTerminator() {
        ...
        while (
            this.arrLexems[this.index].codeLexem == 21 ||
    ...
    inspectStatement() {
        ...
        while (
            this.arrLexems[this.index].codeLexem == 19 ||
        ...
        if (this.arrLexems[this.index].codeLexem == 25) {
            while (this.arrLexems[this.index].codeLexem == 25) {
                ...
                if (this.arrLexems[this.index].codeLexem != 35) {
                    ...
                    if (
                        this.arrLexems[this.index].codeLexem >= 28 &&
